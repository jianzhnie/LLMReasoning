...
def process_and_save_dataset(
    ...
    with output_file.open('w', encoding='utf-8') as f:
        ...
        print(f'🚀 Starting to process {total_examples} examples...')
        ...
        for i, example in enumerate(dataset, start=1):
            ...
            # Write each example as a single line JSON, as required for JSONL.
            json_line = json.dumps(processed, ensure_ascii=False)
            f.write(json_line + '\n')

            # Provide progress updates every 1000 examples.
            if i % 1000 == 0:
