...
-  分布式训练
   ...
   - [多机多卡分布式进程Kill脚本](docs/kill_multi_nodes.md) | [Script](https://gitee.com/jianzhnie/LLMReasoning/blob/main/llmreasoning/llmtoolkit/kill-pid/kill_multi_nodes.sh)
...
-  其他工具
   ...
   - [自动化添加用户脚本](docs/auto_add_user.md) | [Scripts](https://gitee.com/jianzhnie/LLMReasoning/blob/main/scripts/cluster/auto_add_user.sh)
