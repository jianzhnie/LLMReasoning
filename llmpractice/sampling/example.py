...
from llmpractice.sampling.base import Sampler
from llmpractice.sampling.greedy import GreedySampler
from llmpractice.sampling.nucleus import NucleusSampler
from llmpractice.sampling.temperature import TemperatureSampler
from llmpractice.sampling.top_k import TopKSampler
...
def main():
    ...
    with monit.section('top_k=5'):
        sample(
            model,
            tokenizer,
            TopKSampler(2, TemperatureSampler(1.0)),
            4,
            32,
            128,
            prompt,
    ...
    with monit.section('nucleus p=.95'):
        sample(
            model,
            tokenizer,
            NucleusSampler(0.95, TemperatureSampler(1.0)),
            4,
            32,
            128,
            prompt,
    ...
    with monit.section('nucleus p=.1'):
        sample(
            model,
            tokenizer,
            NucleusSampler(0.1, TemperatureSampler(1.0)),
            4,
            32,
            128,
            prompt,
